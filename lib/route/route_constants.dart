...
const String reviewsScreenRoute = "reviews";
const String writeReviewScreenRoute = "write_review";
const String securityScreenRoute = "security";
const String aboutUsScreenRoute = "about_us";
const String termsScreenRoute = "terms";
